...
//         [HttpPost("close")]
//         [Authorize(Roles = "GV")]
//         public async Task<ActionResult<ApiResponse<CloseSessionResponse>>> CloseSession([FromQuery] CloseSessionRequest req)
//         {
//             var username = HelperFunctions.GetUserIdFromClaims(User);
//             var data = await _svc.CloseSessionAsync(req, username);
//             return Ok(new ApiResponse<CloseSessionResponse> { Status = 200, Message = "OK", Data = data });
//         }

//         // POST: /api/attendance/checkin
//         [HttpPost("checkin")]
//         [Authorize(Roles = "SV")]
//         public async Task<ActionResult<ApiResponse<CheckInResponse>>> CheckInByQr([FromQuery] CheckInRequest req)
//         {
//             var username = HelperFunctions.GetUserIdFromClaims(User);
//             var data = await _svc.CheckInByQrAsync(req, username);
//             return Ok(new ApiResponse<CheckInResponse> { Status = 200, Message = "Điểm danh thành công.", Data = data });
//         }
...
//         [Authorize]
//         public async Task<ActionResult<ApiResponse<AttendanceListItem>>> CreateAttendance([FromBody] CreateAttendanceRequest req)
//         {
//             var username = HelperFunctions.GetUserIdFromClaims(User);
//             var data = await _svc.CreateAttendanceAsync(req, username);
//             return Ok(new ApiResponse<AttendanceListItem> { Status = 200, Message = "OK", Data = data });
//         }

//         // PUT: /api/attendance/update-record 
//         [HttpPut("update-record")]
//         [Authorize]
//         public async Task<ActionResult<ApiResponse<AttendanceListItem>>> UpdateAttendance([FromBody] UpdateAttendanceRequest req)
//         {
//             var username = HelperFunctions.GetUserIdFromClaims(User);
